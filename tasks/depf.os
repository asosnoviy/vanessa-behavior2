...
Процедура ИнициализацияОкружения()
	...
	Команда.УстановитьСтрокуЗапуска("oscript ./tools/runner.os decompileepf ./build/features ./features");
	Команда.Исполнить();

	Команда.УстановитьСтрокуЗапуска("oscript ./tools/runner.os decompileepf ./build/epf ./epf");
	Команда.Исполнить();
