...
Процедура ПередНачаломСценария() Экспорт
	...
	ПутьКудаПоложитьEPF = Ванесса.Объект.КаталогИнструментов + СтрЗаменить("\features\support\templates\step_definitions\простаяфичадляпроверкиработывыполнениясценария.epf", "\", "/");
